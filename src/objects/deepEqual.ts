...
export function deepEqual<T>(a: T, b: T, options: ObjectUtilOptions = {}): boolean {
  ...
  function equalInternal(x: any, y: any, depth: number = 0): boolean {
    ...
    const xProps = includeNonEnumerable ? Object.getOwnPropertyNames(x) : Object.keys(x);
    const yProps = includeNonEnumerable ? Object.getOwnPropertyNames(y) : Object.keys(y);
